...
let faveColors = ['blue', 'light-blue', 'dark-blue']
...
me.superHeroName = 'TheGreenThumb'

// The homeTown key value you should be your home town. 
me.homeTown = 'HomeTownsville'
...
me.superPowers = ['Mega Thunder', 'Blast from Down Under', 'Calming Crop Duster']
...
function setColor (arr) {
    if(arr.length > 3){
        let overBy = arr.length - 3;
        arr = arr.splice(overBy, arr.length)
    }
